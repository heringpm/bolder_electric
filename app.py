...
CITY_LANDING_PAGES = {
    'murrieta-ca': {
        ...
        'state': 'CA',
        'slug': 'murrieta-ca',
        'title': 'Electrician in Murrieta, CA - Panel Repair, Upgrades & Electrical Services',
        'description': 'Expert electrician in Murrieta, CA for panel repair, upgrades, replacement, rewiring & 24/7 emergency service. Licensed, insured, local expertise.',
    ...
    'temecula-ca': {
        ...
        'state': 'CA',
        'slug': 'temecula-ca',
        'title': 'Residential Electrician in Temecula, CA | Panel Repair & Emergency Service',
        'description': 'Electrician in Temecula, CA | Residential, Panel Repair & Emergency Service | Bolder Electric',
    ...
    'lake-elsinore-ca': {
        ...
        'title': 'Electrician in Lake Elsinore, CA | Emergency & Residential Electrical Services',
        'description': 'Electrician in Lake Elsinore, CA | Emergency & Residential Electrical Services | Panel Upgrades',
    ...
    'menifee-ca': {
        ...
        'state': 'CA',
        'slug': 'menifee-ca',
        'title': 'Residential Electrician in Menifee, CA | Same Day Emergency & Panel Repair',
        'description': 'Residential Electrician in Menifee, CA | Same Day Service, Panel Repair & Emergency',
    ...
    'perris-ca': {
        ...
        'state': 'CA',
        'slug': 'perris-ca',
        'title': 'Electrician in Perris, CA | Commercial & Residential | 24/7 Emergency Service',
        'description': 'Electrician in Perris, CA | Commercial & Residential Services | 24/7 Emergency Response',
    ...
    'wildomar-ca': {
        ...
        'state': 'CA',
        'slug': 'wildomar-ca',
        'title': 'Electrician Wildomar CA | Same Day Service & Emergency Repairs',
        'description': 'Need a local electrician in Wildomar, CA? Bolder Electric offers same-day emergency repairs, residential service, panel upgrades & 24/7 availability. Licensed & insured.',
    ...
    'hemet-ca': {
        ...
        'state': 'CA',
        'slug': 'hemet-ca',
        'title': 'Electrician in Hemet, CA | Emergency, Residential & Commercial Services',
        'description': 'Emergency electrician in Hemet, CA. Residential & commercial electrical services, panel upgrades, repairs & 24/7 support. Licensed & trusted Riverside County electricians.',
    ...
    'corona-ca': {
        ...
        'state': 'CA',
        'slug': 'corona-ca',
        'title': 'Residential Electrician in Corona, CA | Licensed, 24/7 Emergency & Panel Upgrades',
        'description': 'Residential Electrician in Corona, CA | 24hr Emergency Service, Panel Upgrades & Repairs',
...
SERVICE_LANDING_PAGES = {
    ...
    'residential-electrician-services': {
        ...
        'title': 'Residential Electrician Services in Riverside County | Bolder Electric',
        'description': 'Residential Electrician Services in Riverside County | Troubleshooting, Rewiring & Panel Upgrades | Call Bolder Electric Today (160 characters with CTA)',
